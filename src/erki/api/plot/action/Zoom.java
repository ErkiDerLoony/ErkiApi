        ...
        listener = new MouseWheelListener() {
            ...
            public void mouseWheelMoved(MouseWheelEvent e) {
                ...
                if (e.getWheelRotation() > 0) {
                    plot.setRange((plot.getXMin() - p.getX()) * 1.1 + p.getX(),
                            (plot.getXMax() - p.getX()) * 1.1 + p.getX(),
                            (plot.getYMin() - p.getY()) * 1.1 + p.getY(),
                            (plot.getYMax() - p.getY()) * 1.1 + p.getY());
                } else {
                    plot.setRange((plot.getXMin() - p.getX()) * 0.9 + p.getX(),
                            (plot.getXMax() - p.getX()) * 0.9 + p.getX(),
                            (plot.getYMin() - p.getY()) * 0.9 + p.getY(),
                            (plot.getYMax() - p.getY()) * 0.9 + p.getY());
                }
            }
        };
