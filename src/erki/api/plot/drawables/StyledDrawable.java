...
public abstract class StyledDrawable implements Drawable {
     ...
     * messages if any necessary style property cannot be provided by the current
     * {@code StyleProvider} an hence it might be useful if those {@code StylePropertyKey}s
     * contained a description (see {@link StylePropertyKey#StylePropertyKey(String, String)}).
     * 
