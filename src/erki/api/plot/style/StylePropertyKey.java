...
/**
 * Wraps a {@link String} that is used for internal identification of a style property and adds type
 * information about the described style property.
 * 
...
public class StylePropertyKey<T> implements Comparable<StylePropertyKey<?>> {
     ...
     * 
     * @param key
     *        The {@link String} that is internally used to identify the associated style property.
     * @param description
