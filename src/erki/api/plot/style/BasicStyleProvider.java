...
/**
 * Provides basic style properties for points, lines and coordinate axes. The
...
public class BasicStyleProvider implements StyleProvider {
    ...
    public BasicStyleProvider() {
        ...
        addMapping(new StylePropertyKey<Color>("LINE_COLOR"),
                new StyleProperty<Color>(Color.RED));
