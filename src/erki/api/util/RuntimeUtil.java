...
public class RuntimeUtil {
     ...
     * @throws IOException
     *         If the shell command cannot be executed or either stdout or stderr output of the
     *         shell command cannot be read.
     */
    ...
    /**
     * Execute a command asynchronously. This means do not wait until the executed command
     * terminates and thus return no output generated by the command.
     * 
     * @param cmd
     *        The command to execute.
     */
