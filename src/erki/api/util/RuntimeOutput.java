...
public class RuntimeOutput {
    ...
    /**
     * Creates a new <code>RuntimeOutput</code> instance containing the results of a shell command.
     * 
     * @param stdout
     *        The stdout output of the shell command.
     * @param stderr
    ...
    public String toString() {
        return "-> Command executed: " + cmd + System.getProperty("line.separator")
                + "-> Standard output:" + System.getProperty("line.separator") + stdout
