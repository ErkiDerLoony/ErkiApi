...
public class Crypto {
     ...
     *        The byte to convert.
     * @param buffer
     *        The {@link StringBuffer} into which the string representation of
     *        the byte's hex value is printed.
     */
    ...
    /**
     * This method takes a hex string (as for example generated by
     * {@link #toHexString(byte[])}) and converts it back to a byte array.
     * 
     * @param hex
     *        The hex string.
     * @return A byte array representing the same values that the string
     *         described.
     */
